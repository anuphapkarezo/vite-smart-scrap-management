...
function Smart_Scrap_SearchYearsFactoryMonitor({ onSearch }) {
    ...
    const fetchFactory = async () => {
        try {
          const response = await axios.get("http://10.17.100.115:3001/api/smart_scrap/factorylistMonitor");
          const data  = response.data;

          setDistinctFactory(data);
          console.log('Factory' , distinctFactory);
...
export default Smart_Scrap_SearchYearsFactoryMonitor